...
const hotelsData = [
  {
    ...
    availabilityTo: today.add(10, 'days'), // 10 days
    rooms: 11,
    city: 'Buenos Aires',
    country: 'Argentina',
    price: 4
  },
  {
    ...
    availabilityFrom: today.add(10, 'days'), // 10 days
    availabilityTo: today.add(15, 'days'), // 15 days
    rooms: 23,
    city: 'Mar del Plata',
    country: 'Argentina',
    price: 2
  },
  {
    ...
    availabilityFrom: today.add(5, 'days'), // 5 days
    availabilityTo: today.add(15, 'days'),// 15 days
    rooms: 16,
    city: 'Mendoza',
    country: 'Argentina',
  ...
  },
  {
    ...
    availabilityFrom: today.add(20, 'days'), // 20 days
    availabilityTo: today.add(30, 'days'), // 30 days
    rooms: 32,
    city: 'Jujuy',
    country: 'Argentina',
    price: 1
  },
  {
    ...
    availabilityFrom: today,
    availabilityTo: today.add(5, 'days'), // 5 days
    rooms: 14,
    city: 'Salta',
    country: 'Argentina',
    price: 2
  ...
  },
  {
    ...
    availabilityFrom:today.add(30, 'days'), // 30 days
    availabilityTo: today.add(40, 'days'), // 40 days
    rooms: 40,
  ...
  },
  {
    ...
    availabilityFrom: today.add(10, 'days'), // 10 days
    availabilityTo: today.add(20, 'days'), // 20 days
    rooms: 21,
    city: 'Pucón',
    country: 'Chile',
    price: 4
  ...
  },
  {
    ...
    availabilityFrom: today.add(25, 'days'), // 25 days
    availabilityTo: today.add(30, 'days'),// 30 days
    rooms: 4,
    city: 'Colonia',
    country: 'Uruguay',
